import localhost from "./manifest_dev.json"; // local development manifest
...
export const manifest =
  deployType in manifests ? manifests[deployType as DeployType] : sepolia; // Default to sepolia for production
